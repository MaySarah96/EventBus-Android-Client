...
import com.tn.flow.eventbusandroidclient.handlers.ConnectHandler;
import com.tn.flow.eventbusandroidclient.handlers.Handler;
import com.tn.flow.eventbusandroidclient.handlers.WriteHandler;
import com.tn.flow.eventbusandroidclient.senders.ReplySender;
import com.tn.flow.eventbusandroidclient.util.EventBusMessageAttributes;
...
import static com.tn.flow.eventbusandroidclient.EventBusUtil.addHandler;
import static com.tn.flow.eventbusandroidclient.EventBusUtil.addReplyHandler;
import static com.tn.flow.eventbusandroidclient.EventBusUtil.writeToWire;
...
public class EventBus {
  ...
  public static void connect(String host, int port,final ConnectHandler connectHandler) {
    ...
    log.log(Level.INFO, "Connecting to EventBus Server bootstrap  "+bootstrap.toString());
    ...
    channelFuture.addListener(new ChannelFutureListener() {
      ...
      public void operationComplete(ChannelFuture future) throws Exception {
        ...
        if (future.isSuccess() && channelFuture.isDone() && channelFuture.channel().isActive()) {
          ...
          Log.e(TAG, "operationComplete: "+channel.toString() );
